...
<form method="POST" action="{{ route('register') }}" class="lg:w-1/2 lg:mx-auto bg-white py-12 px-16 rounded shadow">
    ...
    <div class="field mb-6">
        ...
        <div class="control">
            <input id="password-confirmation" type="password" class="input bg-transparent border border-grey-light rounded p-2 text-xs w-full" name="password_confirmation" required>
        </div>
    </div>
